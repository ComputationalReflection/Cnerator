...
with open("all_combinations/main_light.c", "r") as f:
    for line in f:
        
        # This pattern operators with arity 2
        
        m = re.match(r"^([a-zA-Z0-9_$]+)\s+= ([a-zA-Z0-9_$]+)\s+([^ ]+) ([a-zA-Z0-9_$]+)\s+;$", line)
        if m:
        ...
        # This pattern operators with arity 1 (BEFORE)
        ...
        # This pattern operators with arity 1 (AFTER)
