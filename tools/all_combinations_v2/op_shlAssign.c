...
//     float f_2 = 0.1f;
//> warning C4189: 'd_0' : la variable local se ha inicializado pero no se hace referencia a ella
//     double d_0 = 0.2;
...
//     double d_2 = 0.2;
//> warning C4189: 'Ld_0' : la variable local se ha inicializado pero no se hace referencia a ella
