...
{
    bool b_0 = true;
//> warning C4189: 'b_1' : la variable local se ha inicializado pero no se hace referencia a ella
//     bool b_1 = true;
...
//     signed short int sSi_2 = 2;
    unsigned int ui_0 = 3;
//> warning C4189: 'ui_1' : la variable local se ha inicializado pero no se hace referencia a ella
//     unsigned int ui_1 = 3;
...
//> warning C4189: 'uLi_1' : la variable local se ha inicializado pero no se hace referencia a ella
...
//> warning C4189: 'uLLi_1' : la variable local se ha inicializado pero no se hace referencia a ella
...
//> error C2220: advertencia tratada como error; ning·n archivo 'object' generado
//> warning C4804: '-' : uso no seguro del tipo 'bool' en la operaci≤n
//     b_0 = - b_1;
    b_0 = - uc_1;
    b_0 = - sc_1;
    b_0 = - uSi_1;
    b_0 = - sSi_1;
//> warning C4146: operador unario menos aplicado a un tipo unsigned; el resultado a·n no tiene signo
//     b_0 = - ui_1;
    b_0 = - si_1;
//> warning C4146: operador unario menos aplicado a un tipo unsigned; el resultado a·n no tiene signo
//     b_0 = - uLi_1;
...
//     b_0 = - uLLi_1;
    ...
    b_0 = - d_1;
    b_0 = - Ld_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'int [3]'
//     b_0 = - ai_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'double [3]'
//     b_0 = - ad_1;
//> error C2088: '-' : no es vßlido para struct
//     b_0 = - struct$si$si_1;
//> error C2088: '-' : no es vßlido para struct
//     b_0 = - struct$si$si$si_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'char *'
//     b_0 = - pc_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'short *'
//     b_0 = - pSi_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'int *'
//     b_0 = - pi_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'long *'
//     b_0 = - pLi_1;
//> error C2171: '-' : no es vßlido para operandos de tipo '__int64 *'
//     b_0 = - pLLi_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'float *'
//     b_0 = - pf_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'double *'
//     b_0 = - pd_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'long double *'
//     b_0 = - pLd_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'int (*)[]'
//     b_0 = - pai_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'double (*)[]'
//     b_0 = - pad_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'struct1_t *'
//     b_0 = - pstruct$si$si_1;
//> error C2171: '-' : no es vßlido para operandos de tipo 'struct2_t *'
